...
- game:
	- re-add replays
	- finish noteskin support
	- - i wanna use jsons instead of a script, scripts should be only for note kinds
	- finish and use new character system
	- - which would also include flixel-animate later on
