...
class GameplayCustomizeState extends MusicBeatState {
	...
	var front:FlxSprite = new FlxSprite(-650, 600).loadGraphic(Paths.image('stages/week1/stagefront'));

	var sick:FlxSprite = new FlxSprite().loadGraphic(Paths.image('gameplay/ui/score/sick'));
	...
	private function generateStaticArrows(player:Int):Void {
		for (i in 0...4) { // FlxG.log.add(i);
			var babyArrow:FlxSprite = new FlxSprite(0, strumLine.y);
			babyArrow.frames = Paths.getSparrowAtlas('gameplay/noteskins/NOTE_assets');
